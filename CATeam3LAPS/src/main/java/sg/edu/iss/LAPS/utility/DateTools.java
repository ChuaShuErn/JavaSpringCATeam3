...
public class DateTools {
    ...
    public static float countWeekdaysPublicHoliday(Calendar start, Calendar end) {
        ...
        if ((start.get(Calendar.DAY_OF_WEEK) != Calendar.SATURDAY && start.get(Calendar.DAY_OF_WEEK) != Calendar.SUNDAY) && (end.get(Calendar.DAY_OF_WEEK) != Calendar.SATURDAY && end.get(Calendar.DAY_OF_WEEK) != Calendar.SUNDAY)) {
            WeekdaysPublicHoliday = end.get(Calendar.DATE) - start.get(Calendar.DATE) + 1;
        } else if ((start.get(Calendar.DAY_OF_WEEK) != Calendar.SATURDAY && start.get(Calendar.DAY_OF_WEEK) != Calendar.SUNDAY) && (end.get(Calendar.DAY_OF_WEEK) == Calendar.SATURDAY || end.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY)) {
    ...
    public static List<Date> getWeekends(Date startDate, Date endDate) {
